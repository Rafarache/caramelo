...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
		...
		<div class="main_container">
			<h1>CADASTRO</h1>
			<form class="" action="<?php echo e(URL::to('/registro')); ?>" method="post">
...
<?php /**PATH C:\xampp\htdocs\caramelo-main\caramelo-main\resources\views/cadastro.blade.php ENDPATH**/ ?>